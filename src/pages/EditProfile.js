...
import { Box, Center, CheckIcon, HStack, Image, ScrollView, Select, Spinner, Text, VStack } from 'native-base';
...
const EditProfile = ({ navigation }) => {
  ...
  return (
    <SafeAreaView>
      ...
      {isLoading ? (
        <Box height={height / 1.4} justifyContent="center" alignItems="center">
          <Center>
            <VStack space={1}>
              <Spinner color={colors.blue[80]} size="lg" />
              <Text fontSize={width / 30} fontFamily={fonts.primary[400]} color={colors.blue[80]}>
                Loading...
              </Text>
            </VStack>
          </Center>
          ...
          <ScrollView px={width / 26} bgColor={colors.text.white} minH={height} pt={height / 40} showsVerticalScrollIndicator={false}>
            ...
            <VStack space={4} mt={height / 36} mb={height / 8}>
              <VStack space={2}>
                ...
                />
                {updateProfil.errors.nama_lengkap && updateProfil.touched.nama_lengkap ? (
                  <ErrorInput error={updateProfil.errors.nama_lengkap} />
                ) : null}
              </VStack>
              <VStack space={2}>
              ...
              {userData?.id_role === 2 && (
                <VStack space={2}>
                  ...
                  />
                  {updateProfil.errors.berat_badan && updateProfil.touched.berat_badan ? (
                    <ErrorInput error={updateProfil.errors.berat_badan} />
                  ) : null}
                </VStack>
              )}
              {userData?.id_role == 3 && (
