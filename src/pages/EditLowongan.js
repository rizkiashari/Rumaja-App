...
import { Box, CheckIcon, HStack, ScrollView, Select, Spinner, Text, VStack, View } from 'native-base';
    ...
    <View backgroundColor={colors.white} minH={height} pb={9}>
      ...
      {isLoading ? (
        <View flex={1} justifyContent="center" alignItems="center">
          <Spinner color={colors.blue[80]} size="lg" mb={2} />
          <Text fontFamily={fonts.primary[500]} fontSize={width / 30} color={colors.blue[80]}>
            Loading...
          </Text>
        </View>
      ) : (
