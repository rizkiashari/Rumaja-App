...
import { Badge, DaftarWithJumlah, EmptyContent, Header, LoadingSkeleton, Tab } from '../components';
                  ...
                  {isLoading ? (
                    ...
                    dataPelamar?.map((pelamar, index) => (
                      <DaftarWithJumlah
                        ...
                        subTitle={`${pelamar?.kota_lowongan}, ${pelamar?.provinsi_lowongan}`}
                        navDetail={() =>
                  ...
                  {loading ? (
                    ...
                    dataTawaranTerkirim?.map((tawaran, index) => (
                      <DaftarWithJumlah
                        ...
                        subTitle={`${tawaran?.kota_lowongan}, ${tawaran?.provinsi_lowongan}`}
                ...
                {isLoading ? (
                  ...
                  allProgres?.map((progres, index) => (
                    <DaftarWithJumlah
                      ...
                      subTitle={`${progres?.kota_lowongan}, ${progres?.provinsi_lowongan}`}
